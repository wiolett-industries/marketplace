...
import { asTextResult, directionEnum, relationEnum, scopeSchema } from './registry-helpers.js';
...
export function registerGraphTools(server: McpServer): void {
  server.registerTool(
    'memory_path',
    {
      ...
      inputSchema: z.object({ scope: scopeSchema, ...pathFields }),
    },
  ...
  server.registerTool(
    'global_memory_path',
    {
      ...
      inputSchema: z.object(pathFields),
    },
  ...
  server.registerTool(
    'memory_graph_prune',
    {
      ...
      inputSchema: z.object({ scope: scopeSchema, ...pruneFields }),
    },
  ...
  server.registerTool(
    'global_memory_graph_prune',
    {
      ...
      inputSchema: z.object(pruneFields),
    },
