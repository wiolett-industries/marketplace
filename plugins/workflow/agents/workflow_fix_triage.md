...
5. Assign each task an allowed scope, semantic work class, and agent role.
...
- id:
  ...
  agent_role: workflow_implementer | workflow_implementer_standard | workflow_implementer_complex | main
  expected_fix:
```
