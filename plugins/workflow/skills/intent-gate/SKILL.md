...
Use before choosing a workflow path for non-trivial work. Answer: what does the user actually want, and is the obvious reading safe?

Trigger for planning, implementation, refactoring, review, architecture/product decisions, multi-step repo work, or any request where misread scope would change files or risk. Skip only for clearly mechanical low-risk requests.
